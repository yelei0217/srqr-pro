 ...
 * output class name
 */
public class BadDebtsEditUI extends AbstractBadDebtsEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BadDebtsEditUI.class);
    
    /**
     * output class constructor
     */
    public BadDebtsEditUI() throws Exception
    {
        super();
    }
    /**
